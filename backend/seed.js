...
function createPets(cb) {
  async.series([
    function(callback) {
      petCreate('Rufus', 'Dog', "Labrador", 99, users[0], 55, "https://animalso.com/wp-content/uploads/2018/04/Goldador-372x247.jpg", callback);
    },
    function(callback) {
      petCreate('Bob', 'Cat', "Scottish fold", 5, users[0], 45, "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/best-girl-cat-names-1606245046.jpg?crop=0.668xw:1.00xh;0.126xw,0&resize=980:*", callback);
    },
    function(callback) {
      petCreate('Cosmo', 'Cat', 'Domestic shorthair', 4, users[0], 10, "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/best-girl-cat-names-1606245046.jpg?crop=0.668xw:1.00xh;0.126xw,0&resize=980:*", callback);
    },
    function(callback) {
      petCreate('Chirp', 'Bird', "Parakeet", 1, users[0], 11, "https://www.photoblog.com/learn/wp-content/uploads/2019/08/says-phoebe-bird-1024x683.jpg", callback);
    },
    function(callback) {
